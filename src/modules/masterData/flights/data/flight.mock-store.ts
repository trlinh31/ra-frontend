        ...
        dateRanges: [
          {
            ...
            to: "2026-06-30",
            dayGroups: [
              { id: "f1-dg1", label: "T2-T6", days: [1, 2, 3, 4, 5], price: 1500000 },
              { id: "f1-dg2", label: "Cuối tuần", days: [6, 0], price: 1900000 },
            ],
          },
          {
            from: "2026-07-01",
            to: "2026-12-31",
            dayGroups: [
              { id: "f1-dg3", label: "T2-T6", days: [1, 2, 3, 4, 5], price: 1700000 },
              { id: "f1-dg4", label: "Cuối tuần", days: [6, 0], price: 2100000 },
            ],
          },
        ],
      },
        ...
        dateRanges: [
          {
            from: "2026-01-01",
            to: "2026-12-31",
            dayGroups: [{ id: "f2-dg1", label: "Cả tuần", days: [0, 1, 2, 3, 4, 5, 6], price: 1200000 }],
          },
        ],
      },
    ],
