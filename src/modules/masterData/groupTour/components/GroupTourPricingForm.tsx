import GroupTourPricingPeriodForm from "@/modules/masterData/groupTour/components/GroupTourPricingPeriodForm";
...
export default function GroupTourPricingForm() {
      ...
      {fields.map((field, periodIndex) => {
        ...
        return (
          <Section key={field.id} type='dashed' borderColor='red' className='relative'>
            ...
            <GroupTourPricingPeriodForm periodIndex={periodIndex} />
          </Section>
        );
      })}
