import type { GroupTour, GroupTourDayGroup } from "@/modules/masterData/groupTour/types/group-tour.type";
...
interface GroupTourPricingPeriodsTableProps {
  item: GroupTour;
}
                ...
                <CollapsibleContent>
                  <div className='space-y-3 mt-2'>
                    {period.dateRanges.map((dr, drIdx) => {
                      const dgColumns: ColumnDef<GroupTourDayGroup>[] = [
