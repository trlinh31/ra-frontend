import DateRangeDayGroupsForm from "@/modules/masterData/hotel/components/DateRangeDayGroupsForm";
        ...
        <div className='space-y-4'>
          {dateRangeFields.map((field, rangeIdx) => (
            <div key={field.id} className='space-y-4 p-4 border border-gray-300 border-dashed rounded-lg'>
              ...
              <DateRangeDayGroupsForm periodIndex={periodIndex} rangeIndex={rangeIdx} />
            </div>
          ))}
        </div>
