...
import { DEFAULT_FILTERS } from "@/modules/masterData/restaurant/pages/RestaurantListPage";
...
export default function RestaurantFilterBar({ onFilter }: RestaurantFilterBarProps) {
  ...
  return (
    <div className='flex flex-wrap items-end gap-3'>
      <SearchBox value={filters.name} onChange={(value) => handleChange("name", value)} placeholder='Tìm theo tên nhà hàng...' />
