...
import { DEFAULT_FILTERS } from "@/modules/tour/day/pages/DayListPage";
...
export default function DayFilterBar({ onFilter }: DayFilterBarProps) {
  ...
  return (
    <div className='flex flex-wrap items-end gap-3'>
      <SearchBox value={filters.name} onChange={(v) => handleChange("name", v)} placeholder='Tìm theo tên hành trình...' />
