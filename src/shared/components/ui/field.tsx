...
function FieldContent({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot='field-content' className={cn("group/field-content flex flex-col flex-1 gap-0.5 leading-snug", className)} {...props} />;
}
...
function FieldError({
  ...
  return (
    <div role='alert' data-slot='field-error' className={cn("font-semibold text-destructive text-sm", className)} {...props}>
      {content}
    </div>
  );
}
