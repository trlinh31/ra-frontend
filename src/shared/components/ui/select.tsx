...
function SelectGroup({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Group>) {
  return <SelectPrimitive.Group data-slot='select-group' className={cn("p-1 scroll-my-1", className)} {...props} />;
}
...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return <SelectPrimitive.Label data-slot='select-label' className={cn("px-1.5 py-1 text-muted-foreground text-xs", className)} {...props} />;
}
